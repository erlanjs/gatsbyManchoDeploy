    ...
    <section>
      <div className="container mx-auto">
        ...
        <div className="flex flex-col bg-white items-center ssm:block sm:block md:block lg:hidden xl:hidden xxl:hidden">
          <div className="flex bg-red-600 w-full text-white font-[700] text-[50px] mb-[-50px] ssm:text-[30px] sm:text-[40px] md:text-[45px]">
            ВАКА<div className="bg-[#1F1F1F] ">НСИИ</div>
          </div>
        </div>
        <div>
