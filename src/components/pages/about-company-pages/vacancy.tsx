      ...
      <div className="container mx-auto">
        <div className="flex justify-between bg-white items-center ssm:hidden sm:hidden  md:hidden lg:block xl:block xxl:block">
          <div className="flex justify-between items-center leading-0 hidden lg:flex">
            <span className="text-[105px] w-[90%]  text-black pb-[0px] font-[700] lg:w-[90%] lg:text-[90px] lg:pb-[1px] xl:text-[95px] xl:w-[90%] xl:pb-[1px] xxl:text-[100px] xxl:pb-[0.5px]">
              ВАКАН
              <span className="bg-[#1F1F1F] pr-[42%] lg:pr-[33%] xl:pr-[30%]  xxl:pr-[42%] text-white pt-[8px] pb-[205px]">
                СИИ
              </span>
            </span>
