    ...
    <section id={"Contact"}>
      <div className="bg-[#1F1F1F] flex pt-12 lg:hidden ">
        <div className="container mx-auto py-5">
          <h1 className="flex text-[100px] font-[700] font-sans text-white ssm:text-4xl sm:text-5xl sm:w-[100%] md:text-6xl  lg:w-[70%] lg:text-7xl"><span className="pr-8 hidden sm:hidden md:hidden lg:block xl:block xxl:block">Наши</span>Контакты</h1>
        </div>
      </div>
      <div className="container mx-auto">
        ...
        <div className=" mt-6 flex justify-between  flex-wrap ssm:flex ssm:flex-col ssm:justify-start sm:flex sm:flex-col sm:justify-start md:flex md:flex-row md:justify-center lg:flex lg:flex-row lg:justify-between xl:flex xl:flex-row xxl:flex xxl:flex-row xxl:justify-between">
          <div className="pt-16 w-[40%] ssm:w-[80%] ssm:mt-[-70px] sm:w-[80%] sm:mt-[-70px] md:w-[92%] md:mt-[-70px] lg:w-[50%]  xl:w-[45%] xxl:w-[40%] py-5 ">
            ...
            <a href="mailto:hello@mancho.dev?subject=Feedback&body=Message" className="flex items-center">
            ...
            <div className={"my-5 flex"}>
              <a href="https://www.facebook.com/ManchoTeam/?hc_ref=ARTZDICEdqkmDEbtR091xp_j5a8uOpvY8tlUasRym1d-Xo0TlinZJAU8_aXcecGgVtY&ref=nf_target&__xts__[0]=68.ARChehutH7ZAp6Z4K_FnbP0PAKw-XRNEnhUZJY7BfRJwnI8D9QHzjHGzGKA5HCHqi5UnqF9mRcQZKKQWlGzTJeFyAAz9KGEgGjhnBO84akvT_VWsO0XYToQtv9B1eP0zh4KnZG7f9cRuaIySfqz9xTUt-c2XZzl80okphxAi0-lwKZJTet4WjPInIiz4DKkOpTRm_9ExI86LOIQZAKX5td5edvdumPGyUTAUJsqv0DJC_eSC2moqSQQkIFTZ-lfw8fE2o7FMffczQcjzFByOhtT6UgJ27TMA5LBkQFMUJTg5npiwaeU1I8uEjxY28BRrmzQALWiByEdIghY8xLMT0vHAn2Cu9FAMqDNhfT6v2pzjIbLaB0oYF_t661IzM3lSSZnK-Q" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-facebook-f"/></span></a>
              <a href="https://kg.linkedin.com/company/manchodevs" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-linkedin-in"/></span></a>
              <a href="https://t.me/ManchoDevs" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-telegram"/></span></a>
              <a href="https://mobile.twitter.com/manchodevs" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-twitter"/></span></a>
              <a href="https://www.instagram.com/manchodevs/" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-instagram"/></span></a>
              <a href="https://www.youtube.com/c/ManchoDevs" target="_blank"><span className="mr-5 text-2xl"><i className="fa-brands fa-youtube"/></span></a>
