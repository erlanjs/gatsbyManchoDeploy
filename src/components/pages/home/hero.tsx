            ...
            sm:p-0 md:p-0 sm:flex  md:flex md:items-start md:justify-start xl:max-w-full lg:max-w-full'>
              <div className='mt-32 z-30 flex flex-col pr-3'>
                  <div className=' flexitems-center md:block ssm:block sm:block ssm:pl-2 sm:pl-2 md:pl-10 lg:pl-20 xl:pl-32 xxl:pl-32'>
                      ...
                      <span className='font-[900] text-[200px] text-black ml-20 ssm:m-0 sm:m-0 md:m-0 sm:text-[160px] sm:pt-1'>E</span>
                      <span className='font-[900] text-[200px] text-black ml-20 ssm:m-0 sm:m-0 md:m-0 sm:text-[160px]'>V</span>
                    <span className='font-[900] text-[200px] text-white  absolute left-[675px]
                     ssm:left-0 sm:left-0 sm:bg-[#1F1F1F] sm:px-4  sm:text-[159px] sm:m-0 md:m-0 md:left-0 md:bg-[#1F1F1F] md:px-14'>S</span>
                      <span className='absolute right-0  left-[638px] top-96 text-xl text-white
                      ssm:hidden sm:hidden md:hidden lg:block xl:block xxl:block'><span className='text-black pr-1'>we</span> are creative</span>
                  </div>
              ...
              <div className='mt-28 relative md:h-[50%] pl-3 md:w-[89%]
