        ...
        <div style={{background: `url(${bg}) no-repeat `, padding: `${media(10, 110)} 0`}} className="py-[110px]">
          <div  className="container mx-auto ">
            <div className="flex justify-between items-start flex-wrap xl:justify-between">
              <div className="text-[#212121] w-full py-7 sm:w-[360px]">
                <div className="flex items-center">
                  <h1 className="w-9 h-[2px] bg-[#212121] mr-3"/>
                  <h1 className="text-3xl font-semibold ">CarGo</h1>
                </div>
                <p className="font-light text-[14px] mt-2">это готовое решение для оптимизации процессов на таможенных терминалах и в логистических центрах.</p>
                <div className="mt-2">
                  ...
                  <p className="font-light text-[14px] mt-2"><span className="font-bold">Цель CarGo</span>  — помочь оптимизировать и автоматизировать процессы на таможенных и логистических терминалах насколько позволяют технологии, работая как с ПО, так и с железом.</p>
                </div>
              </div>
              <div className="text-[#212121] w-full py-7 sm:w-[360px]">
                <div className="flex items-center">
                ...
                <div className="mt-2">
                  ...
                  <p className="font-light text-[14px] mt-2">Мы помогаем людям найти нужного врача, клинику и работаем над тем, чтобы сократить дистанцию между врачами и пациентами.</p>
                </div>
              </div>
              <div className="text-[#212121] w-full py-7 sm:w-[360px]">
                <div className="flex items-center">
                ...
                <p className="font-light text-[14px] mt-2">это решение для оптимизации процессов в коммерческой сфере.</p>
                <div className="mt-2">
